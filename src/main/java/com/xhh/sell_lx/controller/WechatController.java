...
public class WechatController {
    ...
    public String authorize(@RequestParam("returnUrl")String returnUrl){
        //1.配置
        //2.调用方法
        String url = projectUrlConfig.getWechatMpAuthorize() + contextPath + "/wechat/userInfo";
    ...
    public String qrAuthorize(@RequestParam("returnUrl")String returnUrl){
        String url = projectUrlConfig.getWechatOpenAuthorize() + contextPath + "/wechat/userInfo";
